...
namespace ConsoleSearch
{
    public class DatabaseSqlite : IDatabase
    {
        ...
        List<int> IDatabase.GetWordIds(string[] query, out List<string> outIgnored)
        {
            throw new NotImplementedException();
        }

        List<BEDocument> IDatabase.GetDocDetails(List<int> docIds)
        {
            throw new NotImplementedException();
        }

        List<KeyValuePair<int, int>> IDatabase.GetDocuments(List<int> wordIds)
        {
            throw new NotImplementedException();
        }

        List<int> IDatabase.getMissing(int docId, List<int> wordIds)
        {
            throw new NotImplementedException();
        }

        List<string> IDatabase.WordsFromIds(List<int> wordIds)
        {
            throw new NotImplementedException();
        }

        List<DocumentHit> IDatabase.Search(string term)
        {
            throw new NotImplementedException();
        }
    }
